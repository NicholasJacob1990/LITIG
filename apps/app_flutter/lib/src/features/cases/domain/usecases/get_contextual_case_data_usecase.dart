...
class GetContextualCaseDataUseCase {
  ...
  CaseDetail _convertToCaseDetail(Map<String, dynamic> data) {
    return CaseDetail(
      ...
      assignedLawyer: LawyerInfo.fromJson(data['assigned_lawyer'] as Map<String, dynamic>),
      consultation: ConsultationInfo.fromJson(data['consultation'] as Map<String, dynamic>),
      preAnalysis: PreAnalysis.fromJson(data['pre_analysis'] as Map<String, dynamic>),
      nextSteps: (data['next_steps'] as List<dynamic>? ?? [])
          .map((step) => NextStep.fromJson(step as Map<String, dynamic>))
          .toList(),
      documents: (data['documents'] as List<dynamic>? ?? [])
          .map((doc) => CaseDocument.fromJson(doc as Map<String, dynamic>))
          .toList(),
      processStatus: ProcessStatus.fromJson(data['process_status'] as Map<String, dynamic>),
    );
  }
