...
import '../../../sla_management/presentation/bloc/sla_settings_bloc.dart';
import '../../../sla_management/presentation/bloc/sla_settings_state.dart';
import '../../../sla_management/presentation/bloc/sla_settings_event.dart';
import '../../../sla_management/domain/entities/sla_settings_entity.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<SlaSettingsBloc>()
        ..add(const LoadSlaSettingsEvent(firmId: 'default')),
      child: Scaffold(
        appBar: AppBar(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (slaState is SlaSettingsLoaded && 
                                slaState.settings.allowOverrides)
  ...
  Widget _buildSlaPreview(SlaSettingsState slaState) {
    ...
    if (slaState is SlaSettingsLoaded) {
      ...
      switch (_selectedPriority) {
        case 'urgent':
          slaHours = settings.urgentTimeframe.hours;
          break;
        case 'emergency':
          slaHours = settings.emergencyTimeframe.hours;
          break;
        default:
          slaHours = settings.normalTimeframe.hours;
      }
    ...
    return Column(
      children: [
        SwitchListTile(
          ...
          subtitle: Text(
            'Máximo: ${settings.overrideSettings['maxHours'] ?? 168} horas',
          ),
          ...
          TextFormField(
            ...
            validator: (value) {
              if (_useSlaOverride) {
                ...
                final maxHours = settings.overrideSettings['maxHours'] ?? 168;
                if (hours > maxHours) {
                  return 'Máximo: $maxHours horas';
                }
              }
              return null;
            },
