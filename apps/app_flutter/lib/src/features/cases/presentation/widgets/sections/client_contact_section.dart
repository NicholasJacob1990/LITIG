    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              buildInfoRow(Icons.email_outlined, 'E-mail', email),
              const SizedBox(height: 8),
              buildInfoRow(Icons.phone_outlined, 'Telefone', phone),
              const SizedBox(height: 8),
              buildInfoRow(Icons.chat_outlined, 'Preferência', preferredContact),
            ],
          ),
        ),
      ],
