            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  buildInfoRow(context, Icons.show_chart, 'Média do Mercado', 'R\$ 145/hora'),
                  buildInfoRow(context, Icons.trending_down, 'Seu Preço', 'R\$ 150/hora (+3.4%)'),
                  buildInfoRow(context, Icons.lightbulb, 'Recomendação', 'Manter preço atual'),
                  const SizedBox(height: 12),
                  Container(
