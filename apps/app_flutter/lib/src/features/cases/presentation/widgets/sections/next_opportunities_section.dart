            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  buildInfoRow(Icons.trending_up, 'Demanda Crescente', 'Direito Trabalhista (+23%)'),
                  buildInfoRow(Icons.schedule, 'Melhor Horário', 'Terças e Quintas 14-17h'),
                  buildInfoRow(Icons.attach_money, 'Precificação Ideal', 'R\$ 165-180/hora'),
                  buildInfoRow(Icons.speed, 'Tempo Resposta Alvo', '< 1h para 95% match'),
                  const SizedBox(height: 12),
                  Container(
