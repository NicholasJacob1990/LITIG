            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  buildInfoRow(context, Icons.person, 'Revisor Atual', 'Dra. Maria Santos (Sênior)'),
                  buildInfoRow(context, Icons.schedule, 'Prazo Revisão', '18/01/2025 - 16:00'),
                  buildInfoRow(context, Icons.comment, 'Observações', '2 comentários pendentes'),
                  buildInfoRow(context, Icons.history, 'Histórico', '1ª revisão aprovada'),
                ],
              ),
            ),
