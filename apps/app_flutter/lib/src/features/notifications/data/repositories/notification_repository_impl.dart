...
class NotificationRepositoryImpl implements NotificationRepository {
  ...
  Future<Either<Failure, List<NotificationEntity>>> getNotifications({
    ...
    try {
      ...
      return Left(ServerFailure('Erro ao carregar notificações: $e'));
    }
  }
  ...
  Future<List<NotificationEntity>> _getCachedNotifications() async {
    try {
      final cachedData = await _storageService.getData(_notificationsCacheKey);
      if (cachedData != null) {
      ...
      print('Erro ao ler cache de notificações: $e');
    }
    return [];
  }
  ...
  Future<void> _cacheNotifications(List<NotificationEntity> notifications) async {
    try {
      ...
      await _storageService.saveData(_notificationsCacheKey, cacheData);
    } catch (e) {
      print('Erro ao salvar cache de notificações: $e');
    }
  }
  ...
  Future<void> _clearNotificationsCache() async {
    try {
      await _storageService.removeData(_notificationsCacheKey);
    } catch (e) {
