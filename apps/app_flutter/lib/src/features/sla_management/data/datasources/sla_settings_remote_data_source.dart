...
class SlaSettingsRemoteDataSourceImpl implements SlaSettingsRemoteDataSource {
  ...
  SlaSettingsEntity _getDefaultSlaSettings(String firmId) {
    return SlaSettingsModel.fromJson({
      'id': 'default-$firmId',
      'firm_id': firmId,
      'normal_timeframe': const {'hours': 48, 'priority': 'normal'},
      'urgent_timeframe': const {'hours': 24, 'priority': 'urgent'},
      'emergency_timeframe': const {'hours': 6, 'priority': 'emergency'},
      'complex_timeframe': const {'hours': 72, 'priority': 'complex'},
      'enable_business_hours_only': true,
      'include_weekends': false,
      'allow_overrides': true,
      'enable_auto_escalation': true,
      'override_settings': const {},
