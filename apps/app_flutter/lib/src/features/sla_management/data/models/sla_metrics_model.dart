...
class ComplianceMetricsModel extends ComplianceMetrics {
  ...
  factory ComplianceMetricsModel.fromJson(Map<String, dynamic> json) {
    return ComplianceMetricsModel(
      ...
      compliantCases: json['compliant_cases'] as int,
      nonCompliantCases: json['non_compliant_cases'] as int,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'compliant_cases': compliantCases,
      'non_compliant_cases': nonCompliantCases,
    };
  }
