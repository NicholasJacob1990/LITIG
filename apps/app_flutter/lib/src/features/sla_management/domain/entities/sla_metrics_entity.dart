...
class SlaMetricsEntity extends Equatable {
  ...
  /// Getters de compatibilidade para widgets
  double get overallComplianceRate => complianceMetrics.overallRate * 100;
  Duration get averageResponseTime => performanceMetrics.averageResponseTime;
  int get totalViolations => violationMetrics.totalViolations;
  double get slaScore => overallSlaScore;
  String get scoringLevel {
    final score = slaScore;
