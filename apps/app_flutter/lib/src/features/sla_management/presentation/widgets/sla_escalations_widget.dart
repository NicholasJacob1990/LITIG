              ...
              Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: _getEscalationTypeColor(escalation.triggerType).withValues(alpha: 0.1),
                        ...
                        Row(
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: escalation.isActive ? Colors.green.withValues(alpha: 0.1) : Colors.grey.withValues(alpha: 0.1),
