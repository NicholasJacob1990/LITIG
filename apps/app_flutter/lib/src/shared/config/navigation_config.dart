...
final Map<String, NavigationTab> allPossibleTabs = {
  ...
  'agenda': const NavigationTab(
    ...
    branchIndex: 99, // Rota desativada
...
const Map<String, List<String>> tabOrderByProfile = {
  ...
  'lawyer_individual': [
    'home',
    'contractor_offers', // Posição ajustada
    'partners',
    'partnerships',
    'contractor_cases',
    'contractor_messages',
