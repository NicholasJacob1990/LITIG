        ...
        {filteredCases.map((case_) => (
          <CaseCard
            key={case_.id}
                ...
                statusLabel={case_.statusLabel}
                clientType={case_.clientType}
                createdAt={case_.createdAt}
                nextStep={case_.nextStep}
                hasAiSummary={case_.hasAiSummary}
                summarySharedAt={case_.summarySharedAt}
                unreadMessages={case_.unreadMessages}
