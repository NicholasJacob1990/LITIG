...
import { AccountCreateBody, AccountCreateLinkedinBasicBodySchema, AccountCreateTwitterBodySchema, AccountCreateLinkedinCookieBodySchema, AccountCreateInstagramBodySchema, AccountCreateMessengerBodySchema } from '../../accounts/accounts-create.types.js';
...
export type ReconnectAccountInput = ConnectAccountInput & {
    account_id: string;
};
