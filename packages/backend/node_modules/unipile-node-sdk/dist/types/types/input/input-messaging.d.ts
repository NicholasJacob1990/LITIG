...
export declare function isLinkedinClassicPostNewChatInputOptions(options: LinkedinPostNewChatOptions): options is LinkedinClassicPostNewChatInputOptions;
export declare function isLinkedinRecruiterPostNewChatInputOptions(options: LinkedinPostNewChatOptions): options is LinkedinRecruiterPostNewChatInputOptions;
export {};
